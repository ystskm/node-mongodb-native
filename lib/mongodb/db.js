...
var __executeQueryCommand = function(self, db_command, options, callback) {
  ...
  // if(self._debug) console.log("------------------------------------ __executeQueryCommand :: 0 :: connnection = " + (specifiedConnection != null))
  ...
  // if(self._debug) console.log("------------------------------------ __executeQueryCommand :: 1")
  ...
  // if(self._debug) console.log("------------------------------------ __executeQueryCommand :: 2")

  // If we got a callback object
  if(typeof callback === 'function' && !onAll) {
    // if(self._debug) console.log("------------------------------------ __executeQueryCommand :: 3")
    ...
    connection = connection != null && !connection.connected ? null : connection;
    ...
    // if(self._debug) console.log("------------------------------------ __executeQueryCommand :: 4")
    ...
    // if(self._debug) console.log("------------------------------------ __executeQueryCommand :: 5")
  ...
  var retryFunction = function(_self, _numberOfRetriesDone, _retryInMilliseconds, _numberOfTimes, _command, _db_command, _options, _callback) {
    _self.serverConfig.connect(_self, {}, function(err, result, _serverConfig) {
      ...
      if(err != null && _numberOfRetriesDone > 0) {
        ...
        // _self._debug = true;
        // _self.commands.push(_db_command)
        // Execute command
        command(_self, _db_command, _options, _callback);        
