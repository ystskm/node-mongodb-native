 ...
 */
var Chunk = exports.Chunk = function(gridcommands, mongoObject, writeConcern) {
  if(!(this instanceof Chunk))
    return new Chunk(gridcommands, mongoObject);
  ...
  this.objectId = mongoObjectFinal._id == null ? new ObjectID()
    : mongoObjectFinal._id;
  this.chunkNumber = mongoObjectFinal.n == null ? 0: mongoObjectFinal.n;
  this.chunkSize = mongoObjectFinal.chunkSize || this.gc.internalChunkSize;
  ...
  if(mongoObjectFinal.data == null) {
    ...
    || Object.prototype.toString.call(mongoObjectFinal.data) == "[object Binary]") {
...
Chunk.prototype.save = function(options, callback) {
  ...
  self.gc.chunksCollection(function(er, collection) {
    ...
    collection.remove({
      '_id': self.objectId
    }, writeOptions, function(er, result) {
      ...
      if(self.data.length() > 0) {
        self.buildMongoObject(function(mongoObject) {
          ...
          collection.insert(mongoObject, writeOptions,
