var util = require('util'), debug = require('util').debug, inspect = require('util').inspect;
 ...
 * 
 * @param file
 *          {GridStore} The {@link GridStore} object holding this chunk.
 * @param mongoObject
 *          {object} The mongo object representation of this chunk.
 * 
 * @throws Error
 *           when the type of data field for {@link mongoObject} is not
 *           supported. Currently supported types for data field are instances
 *           of {@link String}, {@link Array}, {@link Binary} and
 *           {@link Binary} from the bson module
 * 
...
var Chunk = exports.Chunk = function(gridcommands, chunkParam) {
   ...
   * @field
   */
  this.__defineGetter__("cursorPosition", function() {
    return this.internalPosition;
  });
  this.__defineSetter__("cursorTo", function(value) {
 ...
 * 
 * @param length
 *          {number} The length of data to read.
 * 
 ...
 * @param callback
 *          {function(*, GridStore)} This will be called after executing this
 *          method. The first parameter will contain null and the second one
 ...
 * 
 * @param callback
 *          {function(Object)} This will be called after executing this method.
 *          The object will be passed to the first parameter and will have the
 *          structure:
 * 
 * <pre><code>
 *        {
 ...
 * 
 * @see <a
 *      href="http://www.mongodb.org/display/DOCS/GridFS+Specification#GridFSSpecification-{{chunks}}">MongoDB
 *      GridFS Chunk Object Structure</a>
 */
