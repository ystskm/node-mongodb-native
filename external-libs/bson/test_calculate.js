...
sys.puts("=== EXECUTING CALCULATE_OBJECT_SIZE TESTS ===");


//
// 1
////////////////////////////////////////////////////////////////////////////
// Test size of Long document
var doc1 = {long:Long2.fromNumber(10000)};
var doc2 = {long:Long.fromNumber(10000)};
// Calculate object size
var size1 = BSON.calculateObjectSize2(doc1);
var size2 = BSONJS.calculateObjectSize(doc2);
// Assert
...
////////////////////////////////////////////////////////////////////////////
// Test size of Long document
var doc1 = {string:'hello world'};
var doc2 = {string:'hello world'};
// Calculate object size
var size1 = BSON.calculateObjectSize2(doc1);
var size2 = BSONJS.calculateObjectSize(doc2);
// Assert
